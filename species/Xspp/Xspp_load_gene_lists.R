# ============================================================
# Xspp Functional Annotation — Seurat/CellChat helper
...
GENE_LISTS_DIR <- "/scratch/dark_genes/annotation_pipeline/runs/Xspp_20260720/08_final/gene_lists"
MASTER_TABLE   <- "/scratch/dark_genes/annotation_pipeline/runs/Xspp_20260720/08_final/Xspp_master_annotation.tsv"
...
# Best human gene name for each Xspp gene
xspp_to_human <- setNames(annot$best_human_gene_name, annot$xspp_gene_id)
xspp_to_human <- xspp_to_human[xspp_to_human != ""]

# Protein group per gene
xspp_to_group <- setNames(annot$protein_group, annot$xspp_gene_id)

# CellChat role per gene
xspp_to_cellchat <- setNames(annot$cellchat_role, annot$xspp_gene_id)
