# ============================================================
# Ofav Functional Annotation — Seurat/CellChat helper
...
GENE_LISTS_DIR <- "/scratch/dark_genes/annotation_pipeline/runs/Ofav_20260618/08_final/gene_lists"
MASTER_TABLE   <- "/scratch/dark_genes/annotation_pipeline/runs/Ofav_20260618/08_final/Ofav_master_annotation.tsv"
...
# Best human gene name for each Ofav gene
ofav_to_human <- setNames(annot$best_human_gene_name, annot$ofav_gene_id)
ofav_to_human <- ofav_to_human[ofav_to_human != ""]

# Protein group per gene
ofav_to_group <- setNames(annot$protein_group, annot$ofav_gene_id)

# CellChat role per gene
ofav_to_cellchat <- setNames(annot$cellchat_role, annot$ofav_gene_id)
