# ============================================================
# Acer Functional Annotation — Seurat/CellChat helper
...
GENE_LISTS_DIR <- "/scratch/dark_genes/annotation_pipeline/runs/Acer_20260618/08_final/gene_lists"
MASTER_TABLE   <- "/scratch/dark_genes/annotation_pipeline/runs/Acer_20260618/08_final/Acer_master_annotation.tsv"
...
# Best human gene name for each Acer gene
acer_to_human <- setNames(annot$best_human_gene_name, annot$acer_gene_id)
acer_to_human <- acer_to_human[acer_to_human != ""]

# Protein group per gene
acer_to_group <- setNames(annot$protein_group, annot$acer_gene_id)

# CellChat role per gene
acer_to_cellchat <- setNames(annot$cellchat_role, annot$acer_gene_id)
