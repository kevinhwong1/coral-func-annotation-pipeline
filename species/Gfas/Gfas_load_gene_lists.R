# ============================================================
# Gfas Functional Annotation — Seurat/CellChat helper
...
GENE_LISTS_DIR <- "/scratch/dark_genes/annotation_pipeline/runs/Gfas_20260605/08_final/gene_lists"
MASTER_TABLE   <- "/scratch/dark_genes/annotation_pipeline/runs/Gfas_20260605/08_final/Gfas_master_annotation.tsv"
...
# Best human gene name for each Gfas gene
gfas_to_human <- setNames(annot$best_human_gene_name, annot$gfas_gene_id)
gfas_to_human <- gfas_to_human[gfas_to_human != ""]

# Protein group per gene
gfas_to_group <- setNames(annot$protein_group, annot$gfas_gene_id)

# CellChat role per gene
gfas_to_cellchat <- setNames(annot$cellchat_role, annot$gfas_gene_id)
