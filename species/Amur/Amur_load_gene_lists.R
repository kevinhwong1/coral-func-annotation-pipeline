# ============================================================
# Amur Functional Annotation — Seurat/CellChat helper
...
GENE_LISTS_DIR <- "/scratch/dark_genes/annotation_pipeline/runs/Amur_20260715/08_final/gene_lists"
MASTER_TABLE   <- "/scratch/dark_genes/annotation_pipeline/runs/Amur_20260715/08_final/Amur_master_annotation.tsv"
...
# Best human gene name for each Amur gene
amur_to_human <- setNames(annot$best_human_gene_name, annot$amur_gene_id)
amur_to_human <- amur_to_human[amur_to_human != ""]

# Protein group per gene
amur_to_group <- setNames(annot$protein_group, annot$amur_gene_id)

# CellChat role per gene
amur_to_cellchat <- setNames(annot$cellchat_role, annot$amur_gene_id)
