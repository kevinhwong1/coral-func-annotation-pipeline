# ============================================================
# Nvec Functional Annotation — Seurat/CellChat helper
...
GENE_LISTS_DIR <- "/scratch/dark_genes/annotation_pipeline/runs/Nvec_20260619/08_final/gene_lists"
MASTER_TABLE   <- "/scratch/dark_genes/annotation_pipeline/runs/Nvec_20260619/08_final/Nvec_master_annotation.tsv"
...
# Best human gene name for each Nvec gene
nvec_to_human <- setNames(annot$best_human_gene_name, annot$nvec_gene_id)
nvec_to_human <- nvec_to_human[nvec_to_human != ""]

# Protein group per gene
nvec_to_group <- setNames(annot$protein_group, annot$nvec_gene_id)

# CellChat role per gene
nvec_to_cellchat <- setNames(annot$cellchat_role, annot$nvec_gene_id)
