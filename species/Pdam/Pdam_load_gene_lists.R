# ============================================================
# Pdam Functional Annotation — Seurat/CellChat helper
...
GENE_LISTS_DIR <- "/scratch/dark_genes/annotation_pipeline/runs/Pdam_20260616/08_final/gene_lists"
MASTER_TABLE   <- "/scratch/dark_genes/annotation_pipeline/runs/Pdam_20260616/08_final/Pdam_master_annotation.tsv"
