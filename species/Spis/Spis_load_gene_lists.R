# ============================================================
# Spis Functional Annotation — Seurat/CellChat helper
...
GENE_LISTS_DIR <- "/scratch/dark_genes/annotation_pipeline/runs/Spis_20260706/08_final/gene_lists"
MASTER_TABLE   <- "/scratch/dark_genes/annotation_pipeline/runs/Spis_20260706/08_final/Spis_master_annotation.tsv"
...
# Best human gene name for each Spis gene
spis_to_human <- setNames(annot$best_human_gene_name, annot$spis_gene_id)
spis_to_human <- spis_to_human[spis_to_human != ""]

# Protein group per gene
spis_to_group <- setNames(annot$protein_group, annot$spis_gene_id)

# CellChat role per gene
spis_to_cellchat <- setNames(annot$cellchat_role, annot$spis_gene_id)
